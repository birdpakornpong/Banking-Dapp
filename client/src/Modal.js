  ...
  return(
    <div className="modaly" onClick={props.onClose}>
      <div className="modal-content" onClick={e => e.stopPropagation()}>
          {/* event.stopPropagation() เป็นการใช้ jQuery Event กับ event.stopPropagation()
           ป้องกันไม่ให้เหตุการณ์จาก bubbling up the DOM tree, การป้องกันการจัดการใด ๆ จาก parent handlers 
           ได้รับแจ้งของเหตุการณ์ */}
